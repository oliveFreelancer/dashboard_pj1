...
import { MainNulsingHomeLost } from "@/utils/service/MainNulsingHomeLost";
...
export default function Home() {
  ...
  useEffect(() => {
    MainNulsingHomeLost.getTreeNodes().then((data) => setNodes(data));
  }, []);
  ...
  return (
    <div className="main relative h-full">
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-50">
        <button
          className={`flex flex-col justify-center items-center w-[32px] y-[32px] bg-gradient-to-b from-lime-300 to-emerald-600 transition-transform rounded-t-lg ${
      ...
      <div className="absolute top-4 left-[22px] flex items-center w-[432px] z-50">
        ...
        <button
          className={`flex flex-col justify-center items-center w-[32px] y-[32px] bg-gradient-to-r from-lime-300 to-emerald-600 transition-transform rounded-r-lg ${
      ...
      <div className="absolute top-4 right-[22px] flex items-center w-[432px] z-50">
        <button
          className={`flex flex-col justify-center items-center w-[32px] y-[32px] bg-gradient-to-r from-lime-300 to-emerald-600 transition-transform rounded-l-lg ${
